...
(function () {
  ...
  const resultsFoundTemplate = '%d résultats trouvés';
  ...
  function displayResults(results, query) {
    ...
    if (!results.length) {
      resultsElement.innerHTML = `<span class="hextra-search-no-result">Pas de résultats trouvés</span>`;
      ...
      if (statusEl) {
        statusEl.textContent = 'Pas de résultats trouvés';
      }
      return;
    }
