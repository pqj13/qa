...
## Cookies
Esta página web no almacena cookies de ningún tipo.

## Protección de datos
### 1. Responsable
**ABOGADOS SCP** es responsable del tratamiento de datos

### 2. Tratamiento de datos

### 3. Ejercicio de sus derechos
...
* Derecho a la portabilidad de sus datos personales, cuando la base legal que nos habilite para su tratamiento de las indicadas en la tabla arriba incluida sea la relación contractual o el consentimiento;
...
Podrá ejercitar sus derechos en cualquier momento y de forma gratuita a través del siguiente **[formulario](#)[^1]** indicando el derecho que desea ejercitar y sus datos identificativos.

[^1]: Formulario externo al sitio web. ABOGADOS SCP no se hace responsable de los datos recogidos por la página externa.